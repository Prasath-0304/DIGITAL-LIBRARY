...
<ul>
  ...
  <li><a href = "edit_book.php"  style="background-color:#FFBF00;border-radius: 12PX"><b>Edit Book</b></a></li>
  ...
  <table style= "color:#000000;padding-top:10px;">
	...
	<tr>
	 ...
	 <td><input type="text" name="authorname" placeholder="books author name"/></td>
        <td style="color:black;font-weight:bold;text-align:center"><?php echo $msg; ?></td>
	</tr>
   ...
   <tr>
	...
	<tr>
	 ...
	 <td><input type="file" name="file"  /></td>
      ...
      <tr>
	  <td><h2><input style="margin-left:170%;margin-top:10%;" type="submit" name="sub" value="RE-UPLOAD"/></h2></td>
	  </tr>
    </table>
    </div>
   </div> 
